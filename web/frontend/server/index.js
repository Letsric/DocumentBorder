...
const app_template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width" />\n		<meta\n			name="description"\n			content="Benutzerdefinierte Ränder mit eigenen Bildern für wunderschöne Dokumente in wenigen Klicks"\n		/>\n		<title>Document Border</title>\n		<script src="https://kit.fontawesome.com/4f92a24291.js" crossorigin="anonymous"><\/script>\n		' + head + '\n	</head>\n	<body>\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n";
